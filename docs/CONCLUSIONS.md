...
| C-05 | hybrid = decord fork 原生（TRT→hybrid_gpu、CPU→宿主帧）。§9-§13：sustained+kick 后 hevc 快纯 NVDEC 23%、达理想 94-97%。§14：旧 av1 折价 −41% 系 16T/32T 错配（同 nt −7~−23%）；hybrid CPU 臂线程档统一为 _decode_num_threads（h264/hevc=32、av1=24；旧 //2=16 档劣 4~13%；以引擎 e2e 为准） | 本机 4060/16C32T；fork dll 281a738 未发布；0.8.2=旧结论 | fork wheel / >32 核档位复测 / 上载天花板量化 | log 2026-09-11-hybrid差距分解 §11-§14；benchmarks hybrid_* |
