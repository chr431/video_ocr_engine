...
| C-40 | **hybrid 收益与片长相关（交叉点三改）**：h264 短窗即胜 nvdec；hevc 交叉点 **~1200**（窗口尾轮后 w1500 −6.1%、w3000 −14.5% 快、w1000 +5.4% 慢；>3000、1500~2000 系旧值伪影）；av1 <3000（w3000 −16.7%）；对纯 CPU 臂三码全片均胜 | 4060/16C32T；fork ≥a6cdeb7（熟前挂起+窗口尾 ETA 派工） | 换卡 / GOP 尺寸极端小 / <500 帧短片 | log 2026-09-18-hybrid启动轮 §4 |
