...
- id: C-54
  conclusion: **启动+窗口尾轮（fork a6cdeb7）：熟前挂起+防饿死盲派+rg 生产侧 sustained+窗口尾 ETA 派工**——盲派 13→2、rg 归真；hevc 交叉点 >3000→~1200（w3000 −14.5%）；耦合损失 h264 28%→~6%、hevc/av1≈0（主体=速率学习被消费节奏污染）
  status: active
